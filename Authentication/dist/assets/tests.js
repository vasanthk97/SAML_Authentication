...
define('zesharing/tests/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/logout-button.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/logout-button.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/index.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/index.js should pass ESLint\n\n11:10 - \'Cookies\' is not defined. (no-undef)');
  });
...
define('zesharing/tests/helpers/module-for-acceptance', ['exports', 'qunit', 'zesharing/tests/helpers/start-app', 'zesharing/tests/helpers/destroy-app'], function (exports, _qunit, _startApp, _destroyApp) {
  'use strict';
...
define('zesharing/tests/helpers/resolver', ['exports', 'zesharing/resolver', 'zesharing/config/environment'], function (exports, _resolver, _environment) {
  'use strict';
...
define('zesharing/tests/helpers/start-app', ['exports', 'zesharing/app', 'zesharing/config/environment'], function (exports, _app, _environment) {
  'use strict';
...
define('zesharing/tests/test-helper', ['zesharing/tests/helpers/resolver', 'ember-qunit', 'ember-cli-qunit'], function (_resolver, _emberQunit, _emberCliQunit) {
  'use strict';

  (0, _emberQunit.setResolver)(_resolver.default);
  (0, _emberCliQunit.start)();
});
define('zesharing/tests/tests.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('integration/components/logout-button-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/logout-button-test.js should pass ESLint\n\n');
  });
...
define('zesharing/tests/unit/routes/index-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
...
define('zesharing/tests/unit/routes/login-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
...
require('zesharing/tests/test-helper');
