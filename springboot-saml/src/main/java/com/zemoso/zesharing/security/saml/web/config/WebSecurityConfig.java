...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SAMLContextProviderLB contextProvider() {
        ...
        contextProvider.setScheme("http");
        contextProvider.setServerName("localhost:4200");
        contextProvider.setServerPort(4200);
...
//		extendedMetadataDelegate.setMetadataRequireSignature(false);
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityId("ZSamlAuth6");
    ...
    public SimpleUrlLogoutSuccessHandler successLogoutHandler() {
        ...
        successLogoutHandler.setDefaultTargetUrl("http://local.ssocircle.com:4200/login");
